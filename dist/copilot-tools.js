...
export const toolDefinitions = [
  ...
  define('navigate_assembly_step', 'Select a step from the current catalog and its linked manual page; pauses animation. Step 0 is the overview.', {step: {type: 'integer', minimum: 0, maximum: 32}}),
